...
* with irrigation plan excecution
* irrigation plan download process 
* created 13/05/2026
*/
...
#define DAILY_ACT_SIZE 16                                               // max number of daily actions in irrigation plan
...
void loop(){
  switch(state){
    case WAIT_SEND:
      ...
      //  application layer - handle client connection and commands, upload irrigation plan from host,
      // scan irrigation plan and activate valves, (optional) manual user tree operation 
